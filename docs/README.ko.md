...
하루에 한 번 "이 설치본이 실행됐다"만 세는 선택 기능도 있습니다. 어떤 수치도, 기기를 알아볼 수 있는
값도 보내지 않고 매일 바뀌는 해시만 나가서 서로 다른 날의 기록을 이어 붙일 수 없습니다. 기본 배포본은
수집 주소가 비어 있어 아무것도 보내지 않습니다. 자세한 내용은 [docs/ANALYTICS.md](ANALYTICS.md).
