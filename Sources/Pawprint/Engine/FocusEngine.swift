...
final class FocusEngine {
    ...
    var graceSeconds: TimeInterval = 45
    /// No input for this long ends the session — an idle Mac parked on one app isn't focus.
    var idleGraceSeconds: TimeInterval = 120
    var focusThresholdSeconds: TimeInterval = 5 * 60
    ...
    typealias Emit = (FocusSessionRecord, [String: Int]) -> Void
    ...
    func appActivated(bundleID: String, name: String, at date: Date, lastActivityAt: Date?, emit: Emit) {
