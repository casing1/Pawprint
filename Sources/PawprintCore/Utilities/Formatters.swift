...
package enum Formatters {
    ...
    static package func longDuration(_ seconds: Int) -> String {
        let h = seconds / 3600
    ...
    static package func compactDuration(_ seconds: Int) -> String {
        let h = seconds / 3600
        let m = (seconds % 3600) / 60
    ...
    static package func wpm(_ value: Double) -> String {
        String(format: "%.0f WPM", value)
    }

    static package func time(_ date: Date) -> String {
    ...
    static package func withObjectParticle(_ text: String) -> String {
    ...
    static package func compactNumber(_ value: Int) -> String {
        let sign = value < 0 ? "-" : ""
        let n = abs(value)
    ...
    static package func exactNumber(_ value: Int) -> String { groupedNumber(value) }
    ...
    static package func exactDuration(_ seconds: Int) -> String {
    ...
    static package func longSpan(_ seconds: Int) -> String {
    ...
    static package func hoursValue(_ hours: Double) -> String {
    ...
    static package func bytesPerSecond(_ value: Double) -> String {
    ...
    static package func hourLabel(_ hour24: Int) -> String {
    ...
    static package func approximateHourLabel(_ hour24: Int) -> String {
    ...
    static package func monthLabel(_ month: String) -> String {
        let formatter = DateFormatter()
        formatter.locale = LocalizationManager.activeLocale
    ...
    static package func shortDayLabel(_ day: String) -> String {
    ...
    static package func dayWithYearLabel(_ day: String) -> String {
        guard let date = DayKey.date(fromDayString: day) else { return day }
        let formatter = DateFormatter()
        formatter.locale = LocalizationManager.activeLocale
    ...
    static package func dayLabel(_ day: String) -> String {
        guard let date = DayKey.date(fromDayString: day) else { return day }
        let formatter = DateFormatter()
        formatter.locale = LocalizationManager.activeLocale
