...
package enum KeyCodeMap {
    ...
    static package func category(for keyCode: UInt16) -> KeyCategory {
        switch keyCode {
    ...
    package enum ANSI {
        static package let a: UInt16 = 0x00
        static package let c: UInt16 = 0x08
        static package let v: UInt16 = 0x09
        static package let x: UInt16 = 0x07
        static package let z: UInt16 = 0x06
        static package let y: UInt16 = 0x10
        static package let three: UInt16 = 0x14
        static package let four: UInt16 = 0x15
        static package let five: UInt16 = 0x17
    }

    static package let tabKeyCode: UInt16 = 0x30
    static package let spaceKeyCode: UInt16 = 0x31
}

package enum KeyCategory: String, Codable, CaseIterable {
    case character
    case backspace
    case delete
    case escape
