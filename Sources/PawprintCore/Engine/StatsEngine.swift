...
package enum StatsEngine {
    ...
    package enum FunFactConstants {
        static package let trackLoopMeters = 400.0
        static package let buildingFloorMeters = 3.2
        static package let a4CharsPerPage = 1800.0
        static package let averageMovieMinutes = 110.0
    }
    ...
    static package func summary(
        ...
        s.cursorDistanceMeters = DisplayCalibration.current.metres(fromPoints: raw.cursorDistancePixels)
        ...
        s.scrollScreens = DisplayCalibration.current.screens(fromScrollPoints: s.totalScrollPoints)
        ...
        s.dragDistanceMeters = DisplayCalibration.current.metres(fromPoints: raw.dragDistancePoints)
    ...
    private static func funFacts(raw: DailyRawCounters, summary: DailySummary) -> [FunFact] {
        ...
        facts += FunConversions.scrollFacts(
            ...
            screenHeightMeters: DisplayCalibration.current.screenHeightMetres
        )
