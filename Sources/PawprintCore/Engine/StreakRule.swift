...
package enum StreakRule {
    ...
    static package func isActive(_ raw: DailyRawCounters) -> Bool {
        raw.activeSeconds > 0 || raw.totalKeyPresses > 0
    }

    static package func isActive(_ summary: DailySummary) -> Bool {
    ...
    static package func streak(endingOn day: String, isActive: (String) -> Bool) -> Int {
        var count = 0
        var cursor = day
    ...
    static package func streaks(for summaries: [DailySummary]) -> [String: Int] {
