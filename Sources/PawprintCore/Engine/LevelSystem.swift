...
package enum QuestTrack: String, CaseIterable, Identifiable {
    case keys
    case clicks
    case cursor
    case scroll
    ...
    package var usesWholeUnits: Bool {
        switch self {
    ...
    package var baseThreshold: Double {
        switch self {
    ...
    package func currentValue(from stats: LifetimeStats) -> Double {
        switch self {
    ...
    static package let maxLevel = 40
    ...
    package func threshold(forLevel level: Int) -> Double {
    ...
    package func formatted(_ value: Double) -> String {
...
package struct QuestProgress: Identifiable {
    package var track: QuestTrack
    package var level: Int
    package var currentValue: Double
    package var levelStart: Double
    package var levelTarget: Double

    package var id: String { track.rawValue }
    ...
    package var remaining: Double { max(0, levelTarget - currentValue) }
    ...
    static package var ranks: [(upTo: Int, name: String)] { [
    ...
    static package var rankCount: Int { ranks.count }
    ...
    static package func build(track: QuestTrack, stats: LifetimeStats) -> QuestProgress {
    ...
    static package func roundedNicely(_ value: Double) -> Double {
    ...
    static package func nextNiceValue(above value: Double, wholeUnits: Bool) -> Double {
...
/// only ever goes up.
package struct OverallLevel {
    package var level: Int
    package var title: String
    package var totalLevels: Int

    static package func build(from quests: [QuestProgress]) -> OverallLevel {
    ...
    static package var titles: [(upTo: Int, name: String)] { [
